...
public class IndexDBWrapper {
	...
	private static PrimaryIndex<String, String> contentIndex;
	private static PrimaryIndex<String, Channel> channelIndex;

	private static File datebaseDir;

	public IndexDBWrapper() {
	}

	public IndexDBWrapper(String path) {
		dbPath = path;
		setup();
	}
	...
	public void setupEnvironment() {
		...
		contentIndex = store.getPrimaryIndex(String.class, String.class);
	 ...
	 * @return
	 */
	public PrimaryIndex<String, String> getAllContents() {
		return contentIndex;
	}

	/**
	 * get content as a list using entity cursor
	 * 
	 * @return
	 */
	public List<String> getContentList() {
		List<String> contentList = new ArrayList<String>();
		EntityCursor<String> cursor = contentIndex.entities();

		try {
			Iterator<String> i = cursor.iterator();
			while (i.hasNext()) {
				contentList.add(i.next());
			}
		} finally {
			cursor.close();
		}
	...
	/**
	 * delete content given url
	 * 
	 * @param url
	 */
	public void deleteContent(String url) {
		contentIndex.delete(url);
	}
}
