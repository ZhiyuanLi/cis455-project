...
/**
 * Language Detector Factory Class. This class manages an initialization and constructions of {@link Detector}.
 * Before using language detection library,
 * load profiles with {@link DetectorFactory#loadProfile(String)} method and set initialization parameters.
 * When the language detection, construct Detector instance via {@libDetectorFactory#create()}.
 * See also {@link Detector}'s sample code. 4x faster improvement based on Elmer Garduno's code. Thanks!
 * @see Detector
...
public class DetectorFactory
{
    	...
    	public static void loadProfile(List<String> json_profiles) throws LangDetectException
	{
    	...
    	/**
     	 ...
     	 * @param langsize - the number of words in the language
     	 * @param index the index to detect
     	 * @throws LangDetectException if the detection fails
     	 */
    	...
    	static public void clear()
	{
    	...
    	/**
     	 ...
     	 * @throws LangDetectException if the detector cannot be created
     	 */
    	static public Detector create() throws LangDetectException
	{
    	...
    	/**
     	 ...
     	 * @return Detector instance
     	 * @throws LangDetectException if an error occurs
     	 */
	 ...
	 * @return Returns the new detector
	 */
