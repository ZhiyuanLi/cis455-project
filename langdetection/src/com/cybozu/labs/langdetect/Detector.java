...
/**
 * {@link Detector} class is to detect language from specified text. Its instance is able to be constructed via the factory class {@link DetectorFactory}.
...
public class Detector
{
    	...
    	public void setAlpha(double alpha)
	{
    	 ...
    	 * @throws LangDetectException if the language cannot be detected
    	 */
    	...
    	public void setMaxTextLength(int max_text_length)
	{
    	...
    	/**
    	 * Append the target text for language detection. This method read the text from specified input reader.
    	 * If the total size of target text exceeds the limit size specified by {@link Detector#setMaxTextLength(int)}, the rest is cut down.
    	...
    	public void append(Reader reader) throws IOException
	{
    	...
    	/**
    	 * Append the target text for language detection. If the total size of target text exceeds the limit size specified by {@link Detector#setMaxTextLength(int)},
    	...
    	public ArrayList<Language> getProbabilities() throws LangDetectException
	{
    	...
    	/**
	 * Detect the language block
     	 * @throws LangDetectException if the block cannot be detected
     	 */
	 ...
	 * @return Returns the string equivalent of the probabilities
	 */
