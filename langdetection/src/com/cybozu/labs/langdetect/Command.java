...
/**
 * LangDetect Command Line Interface. This is a command line interface of Language Detection Library "LandDetect".
...
public class Command
{
	 ...
	 * @param key - the key
	 * @return Returns the associated values
	 */
	 ...
	 * @return Returns a long representing the key
	 */
	...
	/**
	 * Converts the key into a double
	 * @param key - the key to convert
	 * @param defaultValue - the value to default to
	 * @return Returns the double equivalent to the key
	 */
	...
	/**
	 * Returns if the command has the opt
	 * @param opt - the opt to check for
	 * @return Returns true if the command has the opt
	 */
    	...
    	private boolean loadProfile()
	{
    	...
    	/**
     	 * Generate Language Profile from Wikipedia Abstract Database File. usage: --genprofile -d [abstracts directory] [language names]
     	 */
    	public void generateProfile()
	{
    	...
    	/**
    	 * Generate Language Profile from Text File. usage: --genprofile-text -l [language code] [text file path]
    	 */
